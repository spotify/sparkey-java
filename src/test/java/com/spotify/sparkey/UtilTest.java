...
public class UtilTest {
  ...
  public void testConstructor() {
    // stupid test to make code coverage 100%, since at least the IntelliJ coverage instrumentation
    // counts the implicit empty constructor as one method and one line.
