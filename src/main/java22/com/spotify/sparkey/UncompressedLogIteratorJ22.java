...
final class UncompressedLogIteratorJ22 implements Iterator<SparkeyReader.Entry> {
  ...
  public boolean hasNext() {
    ...
    try {
      ...
      if (keyLen == 0) {
        ...
        // Read value length
        valueLen = UncompressedUtilJ22.readVLQInt(logData, p);
  ...
  static final class LogEntry implements SparkeyReader.Entry {
    ...
    LogEntry(SparkeyReader.Type type, int keyLen, byte[] key,
             int valueLen, long valuePosition, long position, int entryIndex,
    ...
    public byte[] getValue() throws IOException {
      ...
      logData.readFully(valuePosition, value, 0, valueLen);
      return value;
    }
